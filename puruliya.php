  ...
  <!-- ======= Hero Section ======= -->
    ...
    <section id="" class="">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">PURULIYA</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="puruliya 1.jpg" class="img-fluid" alt="">
              <div>
                <h4><CENTER>AJODHAY HILL & FORSTE RESERVED AREA</center></h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="puruliya 2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>PANTCHKOTE RAJ FORT PLACECS</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="puru 3.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>MOKUTMONIPUR DHAM</center></h4>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="puruliya 4.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>BARANTI</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <img src="puruliya 5.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4><center>MURGUMA</center></h4>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                  <img src="puruliya 6.jpg" class="img-fluid" alt="">
                  <div class="portfolio-info">
                    <h4><center>SAHEB BANDHE</center></h4>
                  </div>
                </div>
              </div>
</section>
