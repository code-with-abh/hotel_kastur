      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            ...
            <h4>  <li data-filter=".filter-app">KOLKATA</li> </h4>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="kolkata 1.jpg" class="img-fluid" alt="">
              <div>
                <h4><CENTER>VICTORIA</center></h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="kolkata 2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>DHOKINAWAR KALI MONDIR</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="kolkata 3.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>BHEASO BANGLA</center></h4>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="kolkata 4.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>HOWRA BRIDGE</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <img src="kolkata 5.jpeg" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4><center>PRIENSHIP GHAT</center></h4>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                  <img src="kolkata 6.webp" class="img-fluid" alt="">
                  <div class="portfolio-info">
                    <h4><center>DHARMATALA</center></h4>
                  </div>
                </div>
              </div>
</section>
