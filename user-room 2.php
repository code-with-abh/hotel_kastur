            ...
            <div class="col-lg-8 d-flex align-items-stretch">
              <section id="portfolio" class="portfolio">
                  ...
                  <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                      <div class="col-lg-4  portfolio-item filter-app">
                        <div class="portfolio-wrap">
                          ...
                          <div class="portfolio-info">
                            <h4><a href="user booking.php">Louxary Room</a></h4>
                            <p>see more</p>
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                          ...
                          <div class="portfolio-info">
                            <h4><a href="user booking.php">Dormitory Room</a></h4>
                            <p>App</p>
                            <div class="portfolio-links">
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                          ...
                          <div class="portfolio-info">
                            <h4><a href="user booking.php">Dobule Bed Room</a></h4>
                            <p>App</p>
                            <div class="portfolio-links">
               ...
               <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                 <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                   <div class="portfolio-wrap">
                     <img src="luxury-room-1.jpg" height="170px"width="200px">
                     <div class="portfolio-info">
                       <h4><a href="user booking.php">Single Bed Room</a></h4>
                       <p>App</p>
                       <div class="portfolio-links">
                         <a href="assets/img/portfolio/room-1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
                 ...
                 <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                   <div class="portfolio-wrap">
                     <img src="luxury-room-3.jpg" height="170px"width="200px">
                     <div class="portfolio-info">
                       <h4><a href="user booking.php">Deluxe Room</a></h4>
                       <p>App</p>
                       <div class="portfolio-links">
                         <a href="assets/img/portfolio/room-2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 2"><i class="bx bx-plus"></i></a>
                         <a href="portfolio-details.php" title="More Details"><i class="bx bx-link"></i></a>
                 ...
                 <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                   <div class="portfolio-wrap">
                     <img src="luxury-room-4.jpg" height="170px"width="200px">
                     <div class="portfolio-info">
                       <h4><a href="user booking.php">Standerd Suite Room</a></h4>
                       <p>App</p>
                       <div class="portfolio-links">
                         <a href="assets/img/portfolio/room-3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 3"><i class="bx bx-plus"></i></a>
                         <a href="" title="More Details"><i class="bx bx-link"></i></a>
