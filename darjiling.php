  ...
  <!-- ======= Hero Section ======= -->
    ...
    <section id="" class="">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">DARJILING</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="dar 1.jpg" class="img-fluid" alt="">
              <div>
                <h4><CENTER>TIGER HILL</center></h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="dar 2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>OFFBEAT TRAVELS</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="dar 3.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>KANCHANJANGA MOUNTAIN</center></h4>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="dar 4.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>BORBOTAY ROCK GURDEN</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <img src="dar 5.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4><center>TEA GURDEN</center></h4>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                  <img src="dar 6.jpg" class="img-fluid" alt="">
                  <div class="portfolio-info">
                    <h4><center>JAPANEAS PEACES PAGODA</center></h4>
                  </div>
                </div>
              </div>
</section>
