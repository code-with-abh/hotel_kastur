  ...
  <!-- ======= Hero Section ======= -->
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div>
        <th><font face="Berlin Sans FB" size="4" color="red"><center><a href="computer.html">PC</a></center></font></th>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4><a href="user booking.php">dormitory rroom</a></h4>
                <p>see more</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4><a href="user booking.php">single bed room</h4>
                <p>App</p>
                <div class="portfolio-links">
