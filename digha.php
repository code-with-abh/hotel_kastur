  ...
  <!-- ======= Hero Section ======= -->
    ...
    <section id="" class="">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">DIGHA</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="digha 1.jpg" class="img-fluid" alt="">
              <div>
                <h4><CENTER>SHANKARPUR</center></h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="digha 2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>BAKKHALI</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="digha 3.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>NEW DIGHA BEACH</center></h4>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="digha 4.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>UDAIPUR BEACH</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <img src="digha 5.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4><center>TALASARI BEACH</center></h4>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                  <img src="digha 6.jpg" class="img-fluid" alt="">
                  <div class="portfolio-info">
                    <h4><center>CHANADANWAR TAMPLE</center></h4>
                  </div>
                </div>
              </div>
</section>
