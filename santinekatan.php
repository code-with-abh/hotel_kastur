  ...
  <!-- ======= Hero Section ======= -->
    ...
    <section id="" class="">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">SANTINEKTAN</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="san 1.jpg" class="img-fluid" alt="">
              <div>
                <h4><CENTER>KALA BHAVANA</center></h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="san 2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>SANGEET BHAVANA</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="san 3.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>SARKAR RAJBARI</center></h4>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="san 4.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><center>VIDYA BHAVANA</center></h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <img src="san 5.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4><center>AMAR KUTIR</center></h4>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                  <img src="san 6.jpg" class="img-fluid" alt="">
                  <div class="portfolio-info">
                    <h4><center>TAGOR'S ASHRAM</center></h4>
                  </div>
                </div>
              </div>
              <div>
...
<td width="600px" colspan="2"><center><button class="button"><a href="BOOK TOUR GUIDE.php">BOOK YOUR TOUR GUIDE</a></button> </center></td>
